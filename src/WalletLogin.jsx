...
export default function WalletLogin() {
  ...
  const translations = {
    ...
    zh: { header: "🔐 连接钱包",                guidePrefix: "还没有钱包？ ", guideLink: "这里有一个 2 分钟教程。", connect: "使用 {name} 连接", back: "返回登录页面", cookie: "此网站使用 Cookie 来增强您的体验。", accept: "接受" },
    ...
    ja: { header: "🔐 ウォレットを接続",         guidePrefix: "まだウォレットがないですか? ", guideLink: "2 分ガイドはこちら。", connect: "{name} で接続", back: "ログインページに戻る", cookie: "このサイトではクッキーを使用してユーザー体験を向上させています。", accept: "同意する" },
