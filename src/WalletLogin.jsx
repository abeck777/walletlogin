...
export default function WalletLogin() {
  ...
  const translations = {
    ...
    it: { header: "🔐 Connetti portafoglio", guidePrefix: "Non hai ancora un portafoglio? ", guideLink: "Ecco una guida di 2 minuti.", connect: "Connetti con {name}", back: "Torna alla pagina di acceso", cookie: "Questo sito utilizza i cookie per migliorare la tua esperienza.", accept: "Accetta" },
    es: { header: "🔐 Conectar billetera", guidePrefix: "¿No tienes cartera? ", guideLink: "Aquí tienes una guía de 2 minutos.", connect: "Conectar con {name}", back: "Volver a la página inicial", cookie: "Este sitio utiliza cookies para mejorar tu experiencia.", accept: "Aceptar" },
    ...
    hi: { header: "🔐 वॉलेट कनेक्ट करें", guidePrefix: "अभी तक वॉलेट नहीं है? ", guideLink: "यहाँ 2-मिनट मार्गदर्शिका है।", connect: "{name} से कनेक्ट करें", back: "ログिन पेज पर वापस जाएँ", cookie: "यह साइट कुकीज़ का उपयोग करती है।", accept: "स्वीकार करें" },
  ...
  async function connectHandler() {
    ...
    try {
      ...
      const verifyJson = await verifyJson.json();
